...
<head>
    ...
    <title>Product details - African Fashion E-Commerce</title>
                        ...
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <p class="product__details--info__desc mb-15">Lorem ipsum dolor sit amet consectetur
                                    ...
                                    voluptas suscipit cum harum dolor sciunt.</p>
                                <div class="product__variant">
                                    ...
                                    <div class="product__variant--list mb-15">
                                        <a class="variant__wishlist--icon mb-15" href="wishlist"
                                ...
                                <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img"
                                        src="assets/img/other/safe-checkout.png" alt="Payment Image">
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="product__reviews">
                                        ...
                                        <div class="reviews__comment--area">
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="assets/img/other/comment-thumb2.png"
                                                        alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="assets/img/other/comment-thumb3.png"
                                                        alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                            ...
                            <div class="product__items ">
                                ...
                                <div class="product__items--content">
                                    ...
                                    <h4 class="product__items--content__title"><a
                                            href="product-details">Quilted Shoulder Bag</a></h4>
                                    <div class="product__items--price">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details"><img
                                                class="quickview__thumb--img"
                                                src="assets/img/product/big-product2.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details"><img
                                                class="quickview__thumb--img"
                                                src="assets/img/product/big-product3.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details"><img
                                                class="quickview__thumb--img"
                                                src="assets/img/product/big-product4.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                        ...
                        <div class="quickview__info">
                            <form action="#">
                                ...
                                <p class="product__details--info__desc mb-10">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit is. Deserunt totam dolores ea numquam labore! Illum.</p>
                                <div class="product__variant">
                                    <div class="product__variant--list mb-15">
                                        <fieldset class="variant__input--fieldset">
                                            <legend class="product__variant--title mb-8">Color :</legend>
...
<!-- Mirrored from risingtheme.com/html/demo-suruchi-v1/suruchi/product-details by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Sep 2024 14:33:48 GMT -->
