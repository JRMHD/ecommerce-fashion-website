                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link" href="index.html">Dashboard</a>
                                </li>
                                ...
                                <li class="header__menu--items style2">
                                    ...
                                    <ul class="header__sub--menu">
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="shop-right-sidebar.html" class="header__sub--menu__link">Shop
                                                Right
                                                Sidebar</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="product-left-sidebar.html"
                                                class="header__sub--menu__link">Product
                                                Left Sidebar</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                            ...
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    ...
                                    <ul class="header__sub--menu">
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="index.html" class="header__sub--menu__link">Dashboard One</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="index-2.html" class="header__sub--menu__link">Dashboard Two</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="index-3.html" class="header__sub--menu__link">Dashboard Three</a>
                                        </li>
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="blog-details.html" class="header__sub--menu__link">Blog
                                                Details</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="blog-right-sidebar.html" class="header__sub--menu__link">Blog
                                                Right
                                                Sidebar</a>
                                        </li>
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="index.html">Dashboard</a>
                        </li>
                        <li class="offcanvas__menu_li">
                    ...
                    <div class="col-lg-7 mb-28">
                        <div class="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
                            <div class="col mb-28">
                                <div class="banner__items">
                                    <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                            class="banner__items--thumbnail__img" src="assets/img/banner/banner2.png"
                                            alt="banner-img" />
                                        <div class="banner__items--content">
                                            <span class="banner__items--content__subtitle text__secondary">Shop
                                                Women</span>
                                            <h2 class="banner__items--content__title h3">
                                                Up to 70% Off & <br />
                                                Free Shipping
                            ...
                            <div class="col mb-28">
                                <div class="banner__items">
                                    <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                            class="banner__items--thumbnail__img" src="assets/img/banner/banner3.png"
                                            alt="banner-img" />
                                        <div class="banner__items--content">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title">
                                                <a href="product-details.html">High Ankle Jeans</a>
                                            </h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title">
                                                <a href="product-details.html">Light Denim Jacket</a>
                                            </h4>
                                            <div class="product__items--price">
                                ...
                                <div class="col mb-30">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title">
                                                <a href="product-details.html">OSmock Mini Dresss</a>
                                            </h4>
                                            <div class="product__items--price">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.html"><img
                                            class="blog__thumbnail--img" src="assets/img/blog/blog1.png"
                                            alt="blog-img" /></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title">
                                        <a href="blog-details.html">Fashion Trends In 2021 Styles, Colors,
                                            Accessories</a>
                                    </h3>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.html"><img
                                            class="blog__thumbnail--img" src="assets/img/blog/blog2.png"
                                            alt="blog-img" /></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title">
                                        <a href="blog-details.html">Meet the Woman Behind Cool Ethical Label Refor
                                        </a>
                                    </h3>
                                    <a class="blog__content--btn primary__btn" href="blog-details.html">Read more
                                    </a>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.html"><img
                                            class="blog__thumbnail--img" src="assets/img/blog/blog3.png"
                                            alt="blog-img" /></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="blog-details.html"><img
                                            class="blog__thumbnail--img" src="assets/img/blog/blog4.png"
                                            alt="blog-img" /></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta">February 03, 2022</span>
                        ...
                        <div class="quickview__info">
                            <form action="#">
                                ...
                                <p class="product__details--info__desc mb-15">
                                    ...
                                    styles for the modern trendsetter. Our collections are crafted to inspire confidence
                                        ...
                                        <li class="quickview__social--list">
                                            <a class="quickview__social--icon" target="_blank"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="7.667"
                                                    ...
                                                    <path data-name="Path 237"
                                                        d="M967.495,353.678h-2.3v8.253h-3.437v-8.253H960.13V350.77h1.624v-1.888a4.087,4.087,0,0,1,.264-1.492,2.9,2.9,0,0,1,1.039-1