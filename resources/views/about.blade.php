...
<head>
    ...
    <title>About Oga Clothing Africa | Our Story and Mission</title>
    <meta name="description"
        content="Learn about Oga Clothing Africa's journey, our commitment to authentic African fashion, and our mission to bring customizable, high-quality clothing to you.">
    <meta name="keywords" content="about us, African fashion, company history, Oga Clothing Africa">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://ogaclothingafrica.com/about">
    <meta property="og:title" content="About Oga Clothing Africa | Our Story and Mission">
    <meta property="og:description"
        content="Learn about Oga Clothing Africa's journey, our commitment to authentic African fashion, and our mission to bring customizable, high-quality clothing to you.">
    <meta property="og:image" content="https://ogaclothingafrica.com/assets/img/about-og-image.jpg">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://ogaclothingafrica.com/about">
    <meta property="twitter:title" content="About Oga Clothing Africa | Our Story and Mission">
    <meta property="twitter:description"
        content="Learn about Oga Clothing Africa's journey, our commitment to authentic African fashion, and our mission to bring customizable, high-quality clothing to you.">
    <meta property="twitter:image" content="https://ogaclothingafrica.com/assets/img/about-twitter-image.jpg">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            <span class="about__content--subtitle text__secondary mb-20">
                                About Oga Clothing Africa
                            </span>
                            <h2 class="about__content--maintitle mb-25">
                                Luxury African Fashion, Handcrafted for the Elite
                            </h2>
                            <p class="about__content--desc mb-20">
                                Oga Clothing Africa is a premier fashion brand with over a decade of experience in the
                                fashion industry. We cater to clients all across Africa and around the globe,
                                specializing in African cultural and traditional attire for politicians, celebrities,
                                elites, and professionals who want to dress luxuriously and look their best.
                            </p>
                            <p class="about__content--desc mb-20">
                                We provide bespoke services for weddings, anniversaries, birthdays, photoshoots, and
                                more. Our outfits are made from the highest quality materials that are guaranteed not to
                                fade. We also offer complete customization, allowing you to choose your preferred size,
                                measurements, and design. Click on our Customize Button to place your order or connect
                                directly with us via WhatsApp for that luxurious wardrobe upgrade.
                            </p>
                            <div class="about__author position__relative d-flex align-items-center">
                                <div class="about__author--left">
                                    <h4 class="about__author--name">Oga Clothing Africa</h4>
                                    <span class="about__author--rank">Founder & CEO</span>
                                </div>
                                <img class="about__author--signature display-block"
                                    src="assets/img/icon/signature.png" alt="signature" />
                            </div>
                        </div>
                    </div>
                </div>
