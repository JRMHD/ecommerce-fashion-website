                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <h2 class="about__content--maintitle mb-25">
                                Premium Quality Clothing, Directly from the Source
                            </h2>
                            <p class="about__content--desc mb-20">
                                At Ogacloathing Africa, we pride ourselves on offering exclusive clothing that is
                                sourced directly from the manufacturers, not through traders or intermediaries. Our
                                commitment is to provide you with authentic, high-quality apparel that reflects both
                                style and durability.
                            </p>
                            <p class="about__content--desc mb-25">
                                Our mission is to deliver top-notch fashion while ensuring fair pricing and exceptional
                                customer service. We meticulously select our products to meet the highest standards and
                                cater to your unique fashion needs. Experience the difference of shopping with a brand
                                that values quality and integrity.
                            </p>
                            <div class="about__author position__relative d-flex align-items-center">
                                <div class="about__author--left">
                                    <h4 class="about__author--name">Mike</h4>
                                    <span class="about__author--rank">Founder & CEO</span>
                                </div>
                                <img class="about__author--signature display-block" src="assets/img/icon/signature.png"
                                    alt="signature" />
                            </div>
                        </div>
                ...
                <div class="team__container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="assets/img/other/team1.png"
                                        alt="" />
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="assets/img/other/team2.png"
                                        alt="" />
                                </div>
                                <div class="team__content">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="assets/img/other/team3.png"
                                        alt="" />
                                </div>
                                <div class="team__content">
