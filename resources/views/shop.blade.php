        ...
        <div class="offcanvas__filter--sidebar__inner">
                ...
                <ul class="widget__categories--menu">
                    <li class="widget__categories--menu__list">
                        <label class="widget__categories--menu__label d-flex align-items-center">
                            <img class="widget__categories--menu__img" src="assets/img/product/small-product1.png"
                                alt="categories-img">
                    ...
                    <li class="widget__categories--menu__list">
                        <label class="widget__categories--menu__label d-flex align-items-center">
                            <img class="widget__categories--menu__img" src="assets/img/product/small-product2.png"
                                alt="categories-img">
                    ...
                    <li class="widget__categories--menu__list">
                        <label class="widget__categories--menu__label d-flex align-items-center">
                            <img class="widget__categories--menu__img" src="assets/img/product/small-product3.png"
                                alt="categories-img">
                    ...
                    <li class="widget__categories--menu__list">
                        <label class="widget__categories--menu__label d-flex align-items-center">
                            <img class="widget__categories--menu__img" src="assets/img/product/small-product4.png"
                                alt="categories-img">
                    ...
                    <li class="widget__categories--menu__list">
                        <label class="widget__categories--menu__label d-flex align-items-center">
                            <img class="widget__categories--menu__img" src="assets/img/product/small-product5.png"
                                alt="categories-img">
                            <span class="widget__categories--menu__text">Denim Jacket</span>
                            <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                width="12.355" height="8.394">
                ...
                <div class="product__grid--inner">
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details.html">Women Fish Cut
                                    Cloth</a></h3>
                    ...
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details.html">Durable Steel
                                    Knife</a></h3>
                            <div class="product__items--price">
            ...
            <div class="single__widget widget__bg">
                ...
                <ul class="widget__tagcloud">
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Jacket</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Women</a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Oversize</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Cotton </a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Shoulder </a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Winter</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                            href="shop.html">Accessories</a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop.html">Dress </a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="header__shipping">
                        <ul class="header__shipping--wrapper d-flex">
                            <li class="header__shipping--text text-white">
                                Welcome to Ogacloathing Africa Online Store
                            </li>
                            <li class="header__shipping--text text-white d-sm-2-none">
                                <img class="header__shipping--text__icon" src="assets/img/icon/bus.png"
                                    alt="bus-icon" />
                                Track Your Order
                            </li>
                            <li class="header__shipping--text text-white d-sm-2-none">
                                <img class="header__shipping--text__icon" src="assets/img/icon/email.png"
                                    alt="email-icon" />
                                <a class="header__shipping--text__link"
                                    href="mailto:info@ogacloathingafrica.com">info@ogacloathingafrica.com</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title">
                            <a class="main__logo--link" href="index.html"><img class="main__logo--img"
                                    src="assets/img/logo/nav-log.png" alt="logo-img" /></a>
                        </h1>
                    </div>
                                ...
                                <li class="header__menu--items style2">
                                    ...
                                    <ul class="header__sub--menu">
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="shop.html" class="header__sub--menu__link">Shop Left Sidebar</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="shop-right-sidebar.html" class="header__sub--menu__link">Shop Right
                                                Sidebar</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="shop-grid.html" class="header__sub--menu__link">Shop Grid</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="shop-grid-list.html" class="header__sub--menu__link">Shop Grid
                                                List</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="shop-list.html" class="header__sub--menu__link">Shop List</a>
                                        </li>

                                        <!-- Product Sub-menu -->
                                        <li class="header__sub--menu__items">
                                            <a href="product-details.html" class="header__sub--menu__link">Product
                                                Details</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="product-video.html" class="header__sub--menu__link">Video
                                                Product</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="product-left-sidebar.html" class="header__sub--menu__link">Product
                                                Left Sidebar</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="product-gallery.html" class="header__sub--menu__link">Product
                                                Gallery</a>
                                        </li>

                                        <!-- Miscellaneous Pages -->
                                        <li class="header__sub--menu__items">
                                            <a href="my-account.html" class="header__sub--menu__link">My Account</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="404.html" class="header__sub--menu__link">404 Page</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="login.html" class="header__sub--menu__link">Login Page</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="faq.html" class="header__sub--menu__link">Faq Page</a>
                                        </li>

                                        <li class="header__sub--menu__items">
                                            <a href="checkout.html" class="header__sub--menu__link">Checkout Page</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="checkout-2.html" class="header__sub--menu__link">Checkout Style
                                                2</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="checkout-3.html" class="header__sub--menu__link">Checkout Style
                                                3</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="checkout-4.html" class="header__sub--menu__link">Checkout Style
                                                4</a>
                                        </li>

                                        <li class="header__sub--menu__items">
                                            <a href="wishlist.html" class="header__sub--menu__link">Wishlist Page</a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <div class="container-fluid">
                <div
                            ...
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    ...
                                    <ul class="header__sub--menu">
                                        <!-- Home Dropdown Items -->
                                        <li class="header__sub--menu__items">
                                            <a href="index.html" class="header__sub--menu__link">Home One</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="index-2.html" class="header__sub--menu__link">Home Two</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="index-3.html" class="header__sub--menu__link">Home Three</a>
                                        </li>
                                        ...
                                        <!-- Blog Dropdown Items -->
                                        <li class="header__sub--menu__items">
                                            <a href="blog.html" class="header__sub--menu__link">Blog Grid</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="blog-details.html" class="header__sub--menu__link">Blog Details</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="blog-left-sidebar.html" class="header__sub--menu__link">Blog Left
                                                Sidebar</a>
                                        </li>
                                        <li class="header__sub--menu__items">
                                            <a href="blog-right-sidebar.html" class="header__sub--menu__link">Blog Right
                                                Sidebar</a>
                                        </li>

                                        <!-- Other Pages -->
                                        <li class="header__sub--menu__items">
                                            <a href="about.html" class="header__sub--menu__link">About Us</a>
                                        </li>

                                        <li class="header__sub--menu__items">
                                            <a href="cart.html" class="header__sub--menu__link">Cart Page</a>
                                        </li>
                                        ...
                                        <li class="header__sub--menu__items">
                                            <a href="404.html" class="header__sub--menu__link">Error Page</a>
                                        </li>
                    ...
                    <p class="header__discount--text">
                        <img class="header__discount--icon__img" src="assets/img/icon/lamp.png" alt="lamp-img" />
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="assets/img/product/product1.png"
                                alt="prduct-img" /></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="assets/img/product/product2.png"
                                alt="prduct-img" /></a>
                    </div>
                    <div class="minicart__text">
                        <h3 class="minicart__subtitle h4">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Jacket</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Women</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Oversize</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Cotton </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Shoulder </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Winter</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Accessories</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop.html">Dress </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h3 class="product__items--content__title h4"><a
                                                        ...
                                                        <ul class="product__items--action d-flex">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn add__to--cart"
                                                                    ...
                                                                    <span class="add__to--cart__text"> + Add to
                                                                        cart</span>
                                                                </a>
                                                            </li>
                                                            <li class="product__items--action__list">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details.html">Quilted Shoulder Bag</a>
                                                        </h4>
                                                        <div class="product__items--price">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details.html">Aware organic cotton</a>
                                                        </h4>
                                                        <div class="product__items--price">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__list--items d-flex">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Jacket,
                                                            Women</span>
                                                        ...
                                                        <p
                                                            ...
                                                            Quia voluptas dolore doloribus architecto sequi corporis
                                                            deleniti officia culpa dolor esse consectetur eligendi,
                                                            natus at rem ab quae amet molestiae quod voluptates, illo
                                                            exercitationem numquam ipsa. Est fuga ex ipsum alias ipsa
                                                            quibusdam magni harum labore voluptate, esse deserunt saepe
                                                            eveniet.</p>
                                                        <ul class="product__items--action d-flex">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn add__to--cart"
                                                ...
                                                <div class="product__items product__list--items d-flex">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Jacket,
                                                            Women</span>
                                                        <h3 class="product__list--items__content--title h4 mb-10"><a
                                                                href="product-details.html">Square Shoulder Bag</a></h3>
                                                        <div class="product__list--items__price mb-10">
                                                ...
                                                <div class="product__items product__list--items d-flex">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Jacket,
                                                            Women</span>
                                                        <h3 class="product__list--items__content--title h4 mb-10"><a
                                                                href="product-details.html">Light Denim Jackets</a></h3>
                                                        <div class="product__list--items__price mb-10">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__list--items d-flex">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Jacket,
                                                            Women</span>
                                                        <h4 class="product__list--items__content--title mb-10"><a
                                                                href="product-details.html">OSmock Mini Dresss</a></h4>
                                                        <div class="product__list--items__price mb-10">
                                                            <span class="current__price">$125</span>
                                                            <span class="price__divided"></span>
        ...
        <div class="container-fluid">
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <div class="footer__widget--inner">
                        <p class="footer__widget--desc text-ofwhite mb-20">
                            Oga Clothing is a contemporary fashion brand dedicated to
                            offering bold, unique styles for the modern trendsetter. Our
                            collections are crafted to inspire confidence and individuality,
                    ...
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="my-account.html">My Account</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="cart.html">Shopping Cart</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="login.html">Login</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="login.html">Register</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="checkout.html">Checkout</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="wishlist.html">Wishlist</a>
                            </li>
                        </ul>
                    </div>
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            ...
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="portfolio.html">Portfolio</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="privacy-policy.html">Privacy Policy</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="compare.html">Compare</a>
                            </li>
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="faq.html">Frequently</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <div class="footer__widget--inner">
                        <p class="footer__widget--desc text-ofwhite m-0">
                            Enter your email address to subscribe to Ogacloathing notification of our new post &
                            features by email.
                        </p>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content text-ofwhite m-0">
                    ...
                    <a class="copyright__content--link" href="/">Ogacloathing</a>.
