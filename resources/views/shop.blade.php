...
<head>
    ...
    <meta name="description" content="Explore our collection of authentic African fashion. Find customizable clothing and accessories at Oga Clothing Africa's online store.">
    ...
    <meta property="og:description" content="Explore our collection of authentic African fashion. Find customizable clothing and accessories at Oga Clothing Africa's online store.">
    ...
    <meta property="twitter:description" content="Explore our collection of authentic African fashion. Find customizable clothing and accessories at Oga Clothing Africa's online store.">
        ...
        <div class="offcanvas__filter--sidebar__inner">
                ...
                <div class="product__grid--inner">
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details">Women Fish Cut
                                    Cloth</a></h3>
                    ...
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details">Gorgeous
                                    Granite Clock</a></h3>
                            <div class="product__items--price">
                    ...
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details">Durable Steel
                                    Knife</a></h3>
                            <div class="product__items--price">
            ...
            <div class="single__widget widget__bg">
                ...
                <ul class="widget__tagcloud">
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Jacket</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Women</a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Oversize</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Cotton </a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Shoulder </a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Winter</a>
                    </li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                            href="shop">Accessories</a></li>
                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="shop">Dress </a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="product__grid--inner">
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a
                                                    href="product-details">Women Fish Cut</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">$110</span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">$78</span>
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a
                                                    href="product-details">Gorgeous Granite is</a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">$140</span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">$115</span>
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h4 class="product__items--content__title"><a
                                                    href="product-details">Durable A Steel </a></h4>
                                            <div class="product__items--price">
                                                <span class="current__price">$160</span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">$118</span>
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Jacket</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Women</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Oversize</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Cotton </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Shoulder </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Winter</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Accessories</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link"
                                            href="shop">Dress </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h3 class="product__items--content__title h4"><a
                                                                href="product-details">Oversize Cotton Dress</a>
                                                        </h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">$110</span>
                                                            <span class="price__divided"></span>
                                                ...
                                                <div class="product__items ">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h3 class="product__items--content__title h4"><a
                                                                href="product-details">Boxy Denim Jacket</a></h3>
                                                        <div class="product__items--price">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">Quilted Shoulder Bag</a>
                                                        </h4>
                                                        <div class="product__items--price">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">Square Shoulder Bag</a></h4>
                                                        <div class="product__items--price">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">Light Denim Jacket</a></h4>
                                                        <div class="product__items--price">
                                                            <span class="current__price">$125</span>
                                                            <span class="price__divided"></span>
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">Aware organic cotton</a>
                                                        </h4>
                                                        <div class="product__items--price">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">Western denim shirt</a></h4>
                                                        <div class="product__items--price">
                                                            <span class="current__price">$115</span>
                                                            <span class="price__divided"></span>
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">High Ankle Jeans</a></h4>
                                                        <div class="product__items--price">
                                                ...
                                                <div class="product__items">
                                                    ...
                                                    <div class="product__items--content">
                                                        <span class="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        <h4 class="product__items--content__title"><a
                                                                href="product-details">OSmock Mini Dresss</a></h4>
                                                        <div class="product__items--price">
                                                            <span class="current__price">$110</span>
                                                            <span class="price__divided"></span>
                                                            <span class="old__price">$78</span>
                                                ...
                                                <div class="product__items product__list--items d-flex">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Jacket,
                                                            Women</span>
                                                        <h3 class="product__list--items__content--title h4 mb-10"><a
                                                                href="product-details">Square Shoulder Bag</a></h3>
                                                        <div class="product__list--items__price mb-10">
                                                ...
                                                <div class="product__items product__list--items d-flex">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Jacket,
                                                            Women</span>
                                                        <h3 class="product__list--items__content--title h4 mb-10"><a
                                                                href="product-details">Light Denim Jackets</a></h3>
                                                        <div class="product__list--items__price mb-10">
                            ...
                            <div class="pagination__area bg__gray--color">
                                <nav class="pagination justify-content-center">
                                    <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                        ...
                                        <li class="pagination__list"><a href="shop"
        ...
        <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
            <div class="shipping__items2 d-flex align-items-center">
                ...
                <div class="shipping__items2--content">
                    ...
                    <p class="shipping__items2--content__desc">Fast and reliable worldwide delivery through trusted carriers like DHL, UPS, and FedEx.</p>
                </div>
            </div>
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                ...
                <div class="shipping__items2--content">
                    ...
                    <p class="shipping__items2--content__desc">Secure payment options including credit/debit cards and direct bank transfers.</p>
                </div>
            </div>
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                ...
                <div class="shipping__items2--content">
                    ...
                    <p class="shipping__items2--content__desc">Easy returns for all products with a hassle-free process.</p>
                </div>
            </div>
            <div class="shipping__items2 d-flex align-items-center">
                <div class="shipping__items2--icon">
                ...
                <div class="shipping__items2--content">
                    ...
                    <p class="shipping__items2--content__desc">24/7 customer support to assist you with any queries.</p>
                </div>
            </div>
        </div>
    </div>
