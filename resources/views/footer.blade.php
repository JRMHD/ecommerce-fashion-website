     ...
     <div class="container-fluid">
                 ...
                 <div class="footer__widget">
                     ...
                     <ul class="footer__widget--menu footer__widget--inner">
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="my-account">My Account</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="cart">Shopping Cart</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="login">Login</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="login">Register</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="checkout">Checkout</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="wishlist">Wishlist</a>
                         </li>
                     </ul>
                 </div>
                 <div class="footer__widget">
                     ...
                     <ul class="footer__widget--menu footer__widget--inner">
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="about">About Us</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="contact">Contact Us</a>
                         </li>

                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="privacy-policy">Privacy Policy</a>
                         </li>
                         <li class="footer__widget--menu__list">
                             <a class="footer__widget--menu__text" href="faq">Frequently</a>
                         </li>
                     </ul>
                 </div>
             </div>
             ...
             <div class="footer__widget footer__widget--width">
                 ...
                 <div class="footer__widget--inner">
                     <p class="footer__widget--desc text-ofwhite m-0">
                         Enter your email address to subscribe to Ogaclothing notification of our new post &
                         features by email.
                     </p>
                     <div class="newsletter__subscribe">
                         <!-- New form with unique IDs and classes -->
                         <form id="newNewsletterForm" class="newsletter__subscribe--form">
                             @csrf
                             <label>
                                 <input class="new-newsletter__subscribe--input" name="email"
                                     placeholder="Email Address" type="email" required />
                             </label>
                             <button id="newSubscribeBtn" class="new-newsletter__subscribe--button"
                                 type="submit">Subscribe</button>
                         </form>

                         <!-- Loading Spinner for the new form -->
                         <div id="newSubscribeLoadingSpinner"
                         ...
                         <!-- Status Message for the new form -->
                         <div id="newSubscribeMessageStatus"
                         ...
                         <style>
                             ...
                             /* New input styling */
                             .new-newsletter__subscribe--input {
                                 width: 100%;
                                 padding: 10px;
                                 margin-bottom: 10px;
                             ...
                             /* New button styling */
                             .new-newsletter__subscribe--button {
                             ...
                             .new-newsletter__subscribe--button:hover {
                         ...
                         <script>
                             $(document).ready(function() {
                                 // AJAX for the new form
                                 $('#newNewsletterForm').on('submit', function(e) {
                                     e.preventDefault();

                                     // Disable the button and show the loading spinner
                                     $('#newSubscribeBtn').prop('disabled', true);
                                     $('#newSubscribeLoadingSpinner').show();
                                     $('#newSubscribeMessageStatus').hide();

                                     $.ajax({
                                         url: '{{ route('newsletter.subscribe') }}', // Reuse the same route
                                         method: 'POST',
                                         data: $(this).serialize(),
                                         success: function(response) {
                                             // Hide the spinner and show success message
                                             $('#newSubscribeLoadingSpinner').hide();
                                             $('#newSubscribeMessageStatus').text('Thank you for subscribing!').css({
                                                 'background-color': '#d4edda',
                                                 'color': '#155724',
                                                 'border': '1px solid #c3e6cb'
                                             }).show();
                                             $('#newNewsletterForm')[0].reset(); // Clear the form
                                         },
                                         error: function(xhr) {
                                             // Hide the spinner and show error message
                                             $('#newSubscribeLoadingSpinner').hide();
                                             $('#newSubscribeMessageStatus').text(
                                         ...
                                         complete: function() {
                                             ...
                                             $('#newSubscribeBtn').prop('disabled', false);
                                         }
                                     });
                                 });
                             });
         ...
         <div class="footer__bottom d-flex justify-content-between align-items-center">
             <p class="copyright__content text-ofwhite m-0">
                 ...
                 <a class="copyright__content--link" href="/">Ogaclothing</a>.
